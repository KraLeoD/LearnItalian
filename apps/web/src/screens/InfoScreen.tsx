...
import { ActivityIndicator, Card, ProgressBar, Switch, Text, useTheme } from 'react-native-paper';
import { api } from '../api';
...
export function InfoScreen({ dark, onToggleDark }: { dark: boolean; onToggleDark: () => void }) {
  ...
  useEffect(() => { api.info().then(setInfo).catch(() => undefined); }, []);
  ...
  return (
    <View style={styles.page}>
      ...
      <Card mode="elevated"><Card.Content style={styles.section}>
        <Text variant="titleLarge">Monatliche Nutzung</Text>
